    ...
    if replied:
        if replied.audio or replied.voice:
            ...
            if replied.audio:
                ...
                songname = "Voice Note"
            if chat_id in QUEUE:
                pos = add_to_queue(chat_id, songname, dl, link, name, url1, "Audio", 0)
                await huehue.delete()
...
""",                )
                ...
                add_to_queue(chat_id, songname, dl, link, name, url1, "Audio", 0)
                await huehue.delete()
                await m.reply_photo(
                    photo="https://telegra.ph/file/40c0ab31719a780e37b5c.jpg",
                    caption=f"""
        ...
        if len(m.command) < 2:
            ...
            if search == 0:
                ...
                if hm == 0:
                    ...
                    if chat_id in QUEUE:
                        pos = add_to_queue(chat_id, songname, ytlink, url, name, url1, "Audio", 0)
                        await huehue.delete()
                        await m.reply_photo(
                            photo=f"{thumbnail}",
                            caption=f"""
...
""",
                        ...
                        try:
                            ...
                            add_to_queue(chat_id, songname, ytlink, url, name, url1, "Audio", 0)
                            await huehue.delete()
                            # await m.reply_to_message.delete()
                            await m.reply_photo(
                                photo=f"{thumbnail}",
...
async def vplay(client, m: Message):
    ...
    if replied:
        if replied.video or replied.document:
            ...
            if chat_id in QUEUE:
                pos = add_to_queue(chat_id, songname, dl, link, name, url1, "Video", Q)
                await huehue.delete()
                # await m.reply_to_message.delete()
                await m.reply_photo(
                    photo="https://telegra.ph/file/40c0ab31719a780e37b5c.jpg",
...
""",
                ...
                add_to_queue(chat_id, songname, dl, link, name, url1, "Video", Q)
                await huehue.delete()
                # await m.reply_to_message.delete()
                await m.reply_photo(
                    photo="https://telegra.ph/file/40c0ab31719a780e37b5c.jpg",
        ...
        if len(m.command) < 2:
            ...
            if search == 0:
                ...
                if hm == 0:
                    ...
                    if chat_id in QUEUE:
                        pos = add_to_queue(chat_id, songname, ytlink, url, name, url1, "Video", Q)
                        await huehue.delete()
                        await m.reply_photo(
                            photo=f"{thumbnail}",
                            caption=f"""
...
""",                        )
                        ...
                        try:
                            ...
                            add_to_queue(chat_id, songname, ytlink, url, name, url1, "Video", Q)
                            await huehue.delete()
                            await m.reply_photo(
                                photo=f"{thumbnail}",
                                caption=f"""
    ...
    if len(m.command) < 2:
        ...
        try:
            async for x in bot.search_messages(chat, limit=limit, filter="audio"):
                ...
                link = x.link
                if chat_id in QUEUE:
                    add_to_queue(chat_id, songname, location, link, name, url1, "Audio", 0)
                else:
